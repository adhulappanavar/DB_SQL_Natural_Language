...
def test_sql_execution():
    ...
    test_queries = [
        ...
        "SELECT u.first_name, u.last_name, COUNT(wi.id) as assigned_items FROM users u LEFT JOIN ticket_items wi ON u.id = wi.assigned_to GROUP BY u.id ORDER BY assigned_items DESC"
    ]
